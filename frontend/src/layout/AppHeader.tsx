/**
 * Cabeçalho do painel: botão de recolher/expandir a sidebar, alternância
 * de tema claro/escuro e o menu do usuário. Removida a barra de busca
 * genérica e o dropdown de notificações do template (não há recurso
 * equivalente neste sistema).
 */
